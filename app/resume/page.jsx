...
const edu = [
    {
      ...
      info : [
        {
          fieldName: "AMIKOM Yogyakarta University",
          fieldValue: "Bachelor of Information Systems"
        }
      ],
      date: [
        {
          fieldStart: "Sept 2022",
          fieldEnd: "Present"
        }
      ]
    }
          ...
          >
            ...
            <div className="min-h-[70vh] w-full">
              ...
              <TabsContent value="education" className="w-full">
                <div className="flex flex-col gap-[30px] text-center xl:text-left">
                  <h3 className="text-4xl font-bold">{edu[0].title}</h3>
                  <div className="mt-4">
                    {edu[0].info.map((item, index)=>(
                      <p key={index}>
                        <strong>{item.fieldName}.</strong> {item.fieldValue}
                      </p>
                    ))};
